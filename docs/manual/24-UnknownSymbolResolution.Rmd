...
- Determine how to resolve the name
  ...
  - Otherwise, either return `te_nan` (i.e., NaN) or throw an exception
...
The first version will accept the unknown symbol and either return a resolved value or `te_nan`.
